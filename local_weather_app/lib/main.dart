    ...
    return MaterialApp(
        ...
        home: Scaffold(
            ...
            appBar:
                ...
                AppBar(
              elevation:
                  0, //Removes the shadow below the AppBar for a flat design.
            ...
            drawer: Drawer(
              ...
              width: 350,
              child: Builder(
                // Provides a new context that is specific to the Drawer
                builder: (context) {
                  final weatherProvider = Provider.of<WeatherProvider>(context,
                      listen:
                          false); //The listen: false ensures the drawer doesn't rebuild when weatherProvider changes.
                  final cityController =
                      TextEditingController(); //A TextEditingController to capture and manage the city name entered in the TextField.

                  return ListView(
                    //A scrollable column that holds multiple widgets in the drawer
                    children: [
                      ListTile(
                        //Represents a single row with content and an action
                        leading: const Icon(Icons
                            .arrow_back_rounded), // Adds an icon on the left of the ListTile
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller:
                              cityController, // The cityController binds to the TextField to manage its value.
                          cursorColor: Colors.black,
                          keyboardType: TextInputType.name,
                          decoration: const InputDecoration(
                            //Adds styling to the TextField, including a label (City Name) and a border.
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (cityName.isNotEmpty) {
                              final IsCityFound = await weatherProvider
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor:
                                const Color.fromARGB(255, 153, 189, 243),
                          ),
                          child: const Text(
                            'Search',
                      ...
                      ...weatherProvider.cities.map((city) => ListTile(
                            //The ... (spread operator) is used to include these widgets directly into the parent widget (like a Column or ListView).
